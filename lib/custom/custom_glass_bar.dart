              ...
              children: [
                ...
                Row(
                  children: List.generate(items.length, (i) {
                    ...
                    final iconColor = selected ? activeColor : Colors.black;
                    final textColor = selected ? activeColor : Colors.black;
                            ...
                            children: [
                              Stack(
                                ...
                                children: [
                                  ...
                                  else if (it.imagePath != null)
                                    it.imagePath!.endsWith('.svg')
                                      ? SvgPicture.asset(
                                          selected
                                              ? (it.activeImagePath ?? it.imagePath!)
                                              : it.imagePath!,
                                          width: it.iconSize,
                                          height: it.iconSize,
                                          colorFilter: ColorFilter.mode(
                                            selected ? activeColor : Colors.black.withAlpha(180),
                                            BlendMode.srcIn,
                                          ),
                                        )
                                      : Image.asset(
                                          ...
                                          width: it.iconSize,
                                          height: it.iconSize,
                                          color: selected ? activeColor : Colors.black.withAlpha(180),
...
class _SlidingActivePill extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (_, c) {
      ...
      final pillW = (contentW + padH * 2 + pillExtraW).clamp(48.0, slotW - 12.0);
